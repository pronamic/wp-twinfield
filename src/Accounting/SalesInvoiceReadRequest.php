...
class SalesInvoiceReadRequest {
	...
	public function to_dom_document() {
		...
		$read_element->appendChild( $document->createElement( 'type', 'salesinvoice' ) );
		...
		$read_element->appendChild( $document->createElement( 'invoicenumber', $this->number ) );
