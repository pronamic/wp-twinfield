...
<html lang="en">
	...
	<body>
		...
		$office = new \Pronamic\WordPress\Twinfield\Offices\Office( '1000' );
		...
		$options = [
			...
			'dimtype'       => 'DEB',
			'includehidden' => '1',
			'modifiedsince' => $modified_since_datetime->format( 'YmdHis' ),
		];

		$search = new \Pronamic\WordPress\Twinfield\Finder\Search(
			\Pronamic\WordPress\Twinfield\Finder\FinderTypes::DIM,
			'*',
			0,
			$first_row,
			$max_rows,
